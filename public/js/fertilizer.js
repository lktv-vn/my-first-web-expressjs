...
function submenu(){
    ...
    lsSub.forEach((s)=>{
        s.addEventListener('click',()=>{
            ...
            if(vl){
                window.location.href = `/fertilizers/${vl}`;
            }
        })
...
submenu();
// convertAndDisplayText('descriable');
// convertAndDisplayText('used');
// convertAndDisplayText('forPlant');
// convertAndDisplayText('orther');

const lsMenu = ['phan_don', 'complex', 'micro', 'other'];
...
function addEventListenerTolsElement(startId) {
    ...
    lsElement.forEach(li => {
        li.addEventListener('click', function() {
            ...
            window.location.href = `/fertilizers/${userId}`;
